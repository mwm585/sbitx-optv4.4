...
#define WISDOM_MODE FFTW_PATIENT
 char wisdom_file_f[] = "/home/pi/sbitx/data/wisdom_file_f.wis";
#define PLANTIME -1
...
void fft_init()
{
	...
	int e = fftw_import_wisdom_from_filename(wisdom_file_f);
	if (e == 0)
	{
		printf("Generating Wisdom File1...\n");
	}
	...
	if(e==0)fftw_export_wisdom_to_filename(wisdom_file_f);
...
//	if (e == 0)
//	{
//		printf("Generating Wisdom File3...\n");
//	}
	r->plan_rev = fftw_plan_dft_1d(MAX_BINS, r->fft_freq, r->fft_time, FFTW_BACKWARD, WISDOM_MODE); // Was FFTW_ESTIMATE N3SB
//	fftw_export_wisdom_to_filename(wisdom_file_f);
